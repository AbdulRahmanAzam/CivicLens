...
const createUserValidation = [
  ...
  body('role')
    .optional()
    .isIn(['citizen', 'officer', 'supervisor', 'admin'])
...
const getUsersValidation = [
  ...
  query('role')
    .optional()
    .isIn(['citizen', 'officer', 'supervisor', 'admin', 'superadmin'])
    .withMessage('Invalid role'),
  handleValidation,
];
 ...
 * @access  Public
 */
router.post('/login', authRateLimiter, loginValidation, auditAuth('LOGIN'), login);
