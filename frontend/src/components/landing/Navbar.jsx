      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link to="/login" className="text-foreground/80 hover:text-primary font-medium transition-colors duration-200">
              Login
            </Link>
        ...
        >
          <div className="flex flex-col gap-4 pt-4 border-t border-primary/10">
            ...
            <Link to="/login" className="text-foreground/80 hover:text-primary font-medium transition-colors">
              Login
            </Link>
