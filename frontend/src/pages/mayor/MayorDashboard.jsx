...
const issueSeed = [
  {
    ...
    status: 'In progress',
    category: 'Utilities',
    reportedOn: 'Jan 22, 2026',
  },
  {
    id: 'CL-2011',
    title: 'School zone crossing signals needed',
    status: 'In review',
    category: 'Public Safety',
    reportedOn: 'Jan 16, 2026',
  },
  {
    id: 'CL-1996',
    title: 'Illegal dumping reported behind Stadium',
    status: 'Resolved',
    category: 'Sanitation',
    reportedOn: 'Jan 10, 2026',
  },
];
...
const feedbackSeed = [
  {
    ...
    citizen: 'Ayesha K.',
    rating: 'Satisfied',
    message: 'Cleanup was prompt and thorough. Thank you.',
    date: 'Jan 24, 2026',
  },
  {
    id: 'FDB-08',
    ...
    citizen: 'Imran S.',
    rating: 'Neutral',
    message: 'Resolved but communication could improve.',
    date: 'Jan 21, 2026',
  },
];
...
const MayorDashboard = () => {
    ...
    () => [
      {
        id: 'browse',
        label: 'Browse issues',
        description: 'Review civic issues across the city.',
      },
      {
        id: 'register-township',
        label: 'Register township heads',
        description: 'Create accounts for township leadership.',
      },
      {
        id: 'register-uc',
        label: 'Register UC chairmen',
        description: 'Invite union council administrators.',
      },
      {
        id: 'feedback',
        label: 'Citizen feedback',
        description: 'Monitor citizen satisfaction and comments.',
      },
    ],
    []
  );
  ...
  const handleTownshipSubmit = (event) => {
      ...
      <div className="flex">
        <aside className="w-72 min-h-screen border-r border-foreground/10 bg-white/80 backdrop-blur">
          <div className="px-6 py-6 border-b border-foreground/10">
            <p className="text-xs uppercase tracking-[0.2em] text-foreground/50">Mayor Office</p>
            <h1 className="text-xl font-semibold mt-2">CivicLens Mayor Desk</h1>
          </div>
        ...
        <main className="flex-1 px-8 py-8">
          <div className="max-w-5xl">
            ...
            {activeOperation === 'browse' && (
              <section className="bg-white rounded-2xl border border-foreground/10 p-6 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-semibold">Citywide issues</h3>
                    <p className="text-sm text-foreground/60">
                      Review reported issues and prioritize response teams.
                    </p>
                  </div>
            ...
            {activeOperation === 'register-township' && (
              <section className="bg-white rounded-2xl border border-foreground/10 p-6 shadow-sm">
                <h3 className="text-lg font-semibold mb-2">Register township head</h3>
                <p className="text-sm text-foreground/60 mb-6">
                  Create an account to manage township-level issues and resources.
                </p>
                <form onSubmit={handleTownshipSubmit} className="grid gap-4">
                  <div className="grid md:grid-cols-2 gap-4">
                    <label className="text-sm font-medium">
                      ...
                      <input
                        ...
                        placeholder="Township head name"
                        required
                      />
                    </label>
                    <label className="text-sm font-medium">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <p className="text-xs text-foreground/60">
                      An invite email with temporary credentials will be sent automatically.
                    </p>
                    <button
                      type="submit"
                ...
                {townshipSuccess && (
                  <div className="mt-5 rounded-xl border border-secondary/30 bg-secondary/10 px-4 py-3 text-sm text-foreground">
                    Township head registered. Invitation dispatched.
                  </div>
                )}
              </section>
            )}
            ...
            {activeOperation === 'register-uc' && (
              <section className="bg-white rounded-2xl border border-foreground/10 p-6 shadow-sm">
                ...
                <p className="text-sm text-foreground/60 mb-6">
                  Register union council leadership to manage local issue resolution.
                </p>
                <form onSubmit={handleChairmanSubmit} className="grid gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <p className="text-xs text-foreground/60">
                      UC chairmen receive access to neighborhood reporting dashboards.
                    </p>
                    <button
                      type="submit"
                      className="px-6 py-3 rounded-xl bg-primary text-white font-semibold text-sm hover:bg-primary/90 transition-all"
                ...
                {chairmanSuccess && (
                  <div className="mt-5 rounded-xl border border-secondary/30 bg-secondary/10 px-4 py-3 text-sm text-foreground">
                    UC chairman registered. Credentials dispatched.
                  </div>
                )}
              </section>
            )}
              ...
              <section className="bg-white rounded-2xl border border-foreground/10 p-6 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-foreground/60">
                      Review satisfaction feedback after issue resolution.
                    </p>
                  </div>
